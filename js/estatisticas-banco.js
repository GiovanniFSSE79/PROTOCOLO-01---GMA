...
const nav=document.getElementById('resolucao-nav');
const resultBox=document.getElementById('resolucao-result-box');
const rslMain=document.getElementById('resolucao-main');
const isLast=resol_idx===resol_fila.length-1;
resultBox.className='qc-result';
resultBox.innerHTML='';
// FIX layout: garantir que resultBox esteja fora do card (no rsl-main) ao resetar
if(resultBox.parentElement!==rslMain){
  rslMain.insertBefore(resultBox, nav);
}
