...
(function(){
  ...
  function ppSaveIdentity(){
    ...
    // ── Persiste em chave dedicada para sobreviver ao reload ──
    try{
      var saved = JSON.parse(localStorage.getItem('p01_perfil_v1')||'{}');
      saved.nome  = p.displayName;
      saved.email = p.email;
      localStorage.setItem('p01_perfil_v1', JSON.stringify(saved));
    }catch(e){}
